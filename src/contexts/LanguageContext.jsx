...
const translations = {
  en: {
    ...
    howtoFriends: 'Friends',
    howtoFriendsText: 'Make friends by beating NPCs at blackjack in clubs. Each friend has a favorite product and knows about price changes at their location. Visit their location to see their favorite product icon on the travel screen!',
    howtoMail: 'Mail & Tips',
    howtoMailText: 'Your friends will send you insider tips about price changes! When a friend is at a location with upcoming price changes, you\'ll receive mail with valuable information. Higher friend counts mean more tips across different locations.',
    howtoTips: 'Tips',
    ...
    howtoTips4: 'Make friends at clubs to receive insider tips about price changes!',
  ...
  es: {
    ...
    howtoFriends: 'Amigos',
    howtoFriendsText: 'Haz amigos derrotando a NPCs en blackjack en los clubes. Cada amigo tiene un producto favorito y sabe sobre cambios de precios en su ubicación. ¡Visita su ubicación para ver el icono de su producto favorito en la pantalla de viaje!',
    howtoMail: 'Correo y Consejos',
    howtoMailText: '¡Tus amigos te enviarán consejos sobre cambios de precios! Cuando un amigo está en una ubicación con próximos cambios de precios, recibirás correo con información valiosa. Más amigos significan más consejos en diferentes ubicaciones.',
    howtoTips: 'Consejos',
